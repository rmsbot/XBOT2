...
/////////////////
const BotName = 'ShadowBOT'; //ini nama bot lo
const instagram = 'https://www.instagram.com/itsmeikyxsec404/';  //ini nama ig lo
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; //ini kapan bot lo on
const youtube = 'https://youtu.be/lcjjOBBJxv4';//ini channel YouTube lo
